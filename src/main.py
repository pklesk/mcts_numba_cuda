...
AIS = {
    ...
    "mcts_cuda_5_inf_4_128_ocp": MCTSCuda(_BOARD_SHAPE, _EXTRA_INFO_MEMORY, _MAX_ACTIONS, search_time_limit=np.inf, search_steps_limit=10000, n_trees=4, n_playouts=128, kind="ocp", action_to_name_function=_ACTION_TO_NAME_FUNCTION),    
    ...
    "mcts_cuda_5_inf_4_256_acp_prodigal": MCTSCuda(_BOARD_SHAPE, _EXTRA_INFO_MEMORY, _MAX_ACTIONS, search_time_limit=5.0, search_steps_limit=np.inf, n_trees=4, n_playouts=256, kind="acp_prodigal", action_to_name_function=_ACTION_TO_NAME_FUNCTION)                
    } 
...
if __name__ == "__main__":
    ...
    ai_A = AIS["mcts_cuda_5_inf_4_256_acp_prodigal"]
    ai_B = None
