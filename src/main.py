...
N_GAMES = 100
AI_A_SHORTNAME = "mctsnc_60_inf_2_256_ocp_prodigal_16g"
AI_B_SHORTNAME = "mctsnc_60_inf_2_256_acp_prodigal_16g"
...
AIS = {
    ...
    "mctsnc_60_inf_2_256_ocp_prodigal_16g": MCTSNC(_BOARD_SHAPE, _EXTRA_INFO_MEMORY, _MAX_ACTIONS, search_time_limit=60.0, search_steps_limit=np.inf, n_trees=2, n_playouts=256, variant="ocp_prodigal", device_memory=16.0, action_index_to_name_function=_ACTION_INDEX_TO_NAME_FUNCTION),
    "mctsnc_60_inf_2_256_acp_prodigal_16g": MCTSNC(_BOARD_SHAPE, _EXTRA_INFO_MEMORY, _MAX_ACTIONS, search_time_limit=60.0, search_steps_limit=np.inf, n_trees=2, n_playouts=256, variant="acp_prodigal", device_memory=16.0, action_index_to_name_function=_ACTION_INDEX_TO_NAME_FUNCTION)                        
    }
