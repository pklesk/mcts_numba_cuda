...
AI_B_SHORTNAME = "mctsnc_1_inf_4_128_acp_prodigal" 
...
AIS = {
    ...
    "mctsnc_5_inf_8_64_acp_thrifty": MCTSNC(_BOARD_SHAPE, _EXTRA_INFO_MEMORY, _MAX_ACTIONS, search_time_limit=5.0, search_steps_limit=np.inf, n_trees=8, n_playouts=64, variant="acp_thrifty", action_index_to_name_function=_ACTION_INDEX_TO_NAME_FUNCTION),
