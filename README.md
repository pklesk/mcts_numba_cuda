...
Assume the mechanics of the Connect 4 game have been defined to MCTS-NC in `mctsnc_game_mechanics.py` module (i.e. functions `is_action_legal`, `take_action`, etc.), 
...
Assume the mechanics of the Gomoku game have been defined to MCTS-NC in `mctsnc_game_mechanics.py` module (i.e. functions `is_action_legal`, `take_action`, etc.), 
