...
def scores_plot_ocp_prodigal_vs_vanilla():
    experiments_hs_array = np.array([
    ...
    scores_plot_generator(experiments_hs_array, "$m$ (n_playouts)", "$T$ (n_trees)", [32, 64, 128, 256], [1, 2, 4, 8], None, "MCTS-NC OCP-PRODIGAL (1s) \nvs MCTS VANILLA (4s)")
...
if __name__ == "__main__":        
    ...
    scores_plot_ocp_prodigal_vs_vanilla()
